  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button
        ...
        className="flex items-center gap-2 rounded-full border-[1.5px] border-white/30 bg-white/5 px-3 py-1.5 transition-all duration-200 hover:border-white/60 hover:bg-white/10 cursor-pointer"
      >
        {/* Avatar circle */}
        <span className="flex h-6 w-6 items-center justify-center rounded-full bg-white/20 font-['Plus_Jakarta_Sans',sans-serif] text-xs font-bold text-white">
          {initials}
        </span>
        {/* Email truncated */}
        <span className="max-w-[140px] truncate font-['Plus_Jakarta_Sans',sans-serif] text-sm text-white/70">
          {user?.email}
        </span>
        {/* Chevron */}
        <svg
