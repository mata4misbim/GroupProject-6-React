...
export default function StatsSection() {
  return (
    <section className="mx-[10%] my-12 font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <div className="grid grid-cols-4 gap-8">
        {stats.map((stat) => (
          <div key={stat.label} className="flex flex-col items-center gap-3 text-center">
            <span className="text-[52px] font-extrabold leading-none text-accent [text-shadow:0_0_16px_rgba(252,60,68,0.4),0_0_32px_rgba(252,60,68,0.15)]">
              {stat.value}
            </span>
